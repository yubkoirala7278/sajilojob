...
class ImageUploadingHelper
{
    ...
    public static function UploadImage($destinationPath, $field, $newName = '', $width, $height, $makeOtherSizesImages = true)
    {
        if ($width > 0 && $height > 0) {
        ...
        $imageToResize->resize(self::$mainImgWidth,self::$mainImgHeight)->save($destinationPath . '/' . $fileName);
