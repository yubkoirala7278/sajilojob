...
trait CompanyPackageTrait
{
    ...
    public function addCompanyPackage($company, $package)
    {
        ...
        $company->availed_jobs_quota = $package->package_num_listings;
        $company->update();
    }
    ...
    public function updateCompanyPackage($company, $package)
    {
        ...
        $company->availed_jobs_quota = ($company->jobs_quota - $company->availed_jobs_quota) + $package->package_num_listings;
        $company->update();
    }
