...
<div class="form-body">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group {!! APFrmErrHelp::hasError($errors, 'bg_image') !!}">
                <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <span class="btn default btn-file"> 
                        <span class="fileinput-new"> Select Company Background Image 
                        </span> 
                        <span class="fileinput-exists"> Change 
                        </span> {!! Form::file('bg_image', null, array('id'=>'bg_image')) !!} 
                    </span> 
                    <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput"> Remove </a> 
                    </div>
                </div>
                {!! APFrmErrHelp::showErrors($errors, 'bg_image') !!} </div>
        </div>
        @if(isset($company))
        <div class="col-md-6">
            {{ ImgUploader::print_image("company_bg_images/$company->bg_image") }}        
        </div>    
        @endif  
    </div>
