...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'company_id') !!}" id="company_id_div">
        ...
        {!! Form::select('company_id', ['' => 'Select Company'] + $companies, null, ['class' => 'form-control', 'id' => 'company_id']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'description') !!}">
        ...
        {!! Form::textarea('description', null, ['class' => 'form-control', 'id' => 'description', 'placeholder' => 'Job description']) !!}
        {!! APFrmErrHelp::showErrors($errors, 'description') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'specification') !!}">
        {!! Form::label('specification', 'Job specification', ['class' => 'bold']) !!}
        {!! Form::textarea('specification', null, ['class' => 'form-control', 'id' => 'specification', 'placeholder' => 'Job specification']) !!}
        {!! APFrmErrHelp::showErrors($errors, 'specification') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'benefits') !!}">
        {!! Form::label('benefits', 'Job benefits', ['class' => 'bold']) !!}
        {!! Form::textarea('benefits', null, ['class' => 'form-control', 'id' => 'benefits', 'placeholder' => 'Job benefits']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'country_id') !!}" id="country_id_div">
        ...
        {!! Form::select('country_id', ['' => 'Select Country'] + $countries, old('country_id', isset($job) ? $job->country_id : $siteSetting->default_country_id), ['class' => 'form-control', 'id' => 'country_id']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'career_level_id') !!}" id="career_level_id_div">
        ...
        {!! Form::select('career_level_id', ['' => 'Select Career level'] + $careerLevels, null, ['class' => 'form-control', 'id' => 'career_level_id']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary') !!}" id="salary_to_div">
        {!! Form::label('salary', 'Salary', ['class' => 'bold']) !!}
        {!! Form::text('salary', null, ['class' => 'form-control', 'id' => 'salary', 'placeholder' => 'Salary']) !!}
        {!! APFrmErrHelp::showErrors($errors, 'salary') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}" id="salary_currency_div">
        ...
        {!! Form::select('salary_currency', ['' => 'Select Salary Currency'] + $currencies, null, ['class' => 'form-control', 'id' => 'salary_currency']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary_period_id') !!}" id="salary_period_id_div">
        ...
        {!! Form::select('salary_period_id', ['' => 'Select Salary Period'] + $salaryPeriods, null, ['class' => 'form-control', 'id' => 'salary_period_id']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}" id="functional_area_id_div">
        ...
        {!! Form::select('functional_area_id', ['' => 'Select Functional Area'] + $functionalAreas, null, ['class' => 'form-control', 'id' => 'functional_area_id']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_type_id') !!}" id="job_type_id_div">
        ...
        {!! Form::select('job_type_id', ['' => 'Select Job Type'] + $jobTypes, null, ['class' => 'form-control', 'id' => 'job_type_id']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_shift_id') !!}" id="job_shift_id_div">
        ...
        {!! Form::select('job_shift_id', ['' => 'Select Job Shift'] + $jobShifts, null, ['class' => 'form-control', 'id' => 'job_shift_id']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'num_of_positions') !!}" id="num_of_positions_div">
        ...
        {!! Form::select('num_of_positions', ['' => 'Select Positions#'] + MiscHelper::getNumPositions(), null, ['class' => 'form-control', 'id' => 'num_of_positions']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}" id="gender_id_div">
        ...
        {!! Form::select('gender_id', ['' => __('No preference')] + $genders, null, ['class' => 'form-control', 'id' => 'gender_id']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'expiry_date') !!}">
        ...
        {!! Form::text('expiry_date', null, ['class' => 'form-control datepicker', 'id' => 'expiry_date', 'placeholder' => 'Job expiry date', 'autocomplete' => 'off']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div">
        ...
        {!! Form::select('degree_level_id', ['' => 'Select Required Degree Level'] + $degreeLevels, null, ['class' => 'form-control', 'id' => 'degree_level_id']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}" id="job_experience_id_div">
        ...
        {!! Form::select('job_experience_id', ['' => 'Select Required job experience'] + $jobExperiences, null, ['class' => 'form-control', 'id' => 'job_experience_id']) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_top') !!}">
        {!! Form::label('is_top', 'Is Top?', ['class' => 'bold']) !!}
        <div class="radio-list">
            <?php
            $is_top_1 = '';
            $is_top_2 = 'checked="checked"';
            if (old('is_top', isset($job) ? $job->is_top : 0) == 1) {
                $is_top_1 = 'checked="checked"';
                $is_top_2 = '';
            }
            ?>
            <label class="radio-inline">
                <input id="top" name="is_top" type="radio" value="1" {{ $is_top_1 }}>
                Top </label>
            <label class="radio-inline">
                <input id="not_top" name="is_top" type="radio" value="0" {{ $is_top_2 }}>
                Not Top </label>
        </div>
        {!! APFrmErrHelp::showErrors($errors, 'is_top') !!}
    </div>

    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_hot') !!}">
        {!! Form::label('is_hot', 'Is Hot?', ['class' => 'bold']) !!}
        <div class="radio-list">
            <?php
            $is_hot_1 = '';
            $is_hot_2 = 'checked="checked"';
            if (old('is_hot', isset($job) ? $job->is_hot : 0) == 1) {
                $is_hot_1 = 'checked="checked"';
                $is_hot_2 = '';
            }
            ?>
            <label class="radio-inline">
                <input id="hot" name="is_hot" type="radio" value="1" {{ $is_hot_1 }}>
                Hot </label>
            <label class="radio-inline">
                <input id="not_hot" name="is_hot" type="radio" value="0" {{ $is_hot_2 }}>
                Not hot </label>
        </div>
        {!! APFrmErrHelp::showErrors($errors, 'is_hot') !!}
    </div>
