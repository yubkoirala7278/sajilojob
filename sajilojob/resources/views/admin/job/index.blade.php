                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="jobDatatableAjax">
                                        <thead>
                                            <tr role="row" class="filter">
                                                <td>{!! Form::select('company_id', ['' => 'Select Company'] + $companies, null, ['id' => 'company_id', 'class' => 'form-control']) !!}</td>
                                                ...
                                                <td>
                                                    ...
                                                    {!! Form::select('country_id', ['' => 'Select Country'] + $countries, $default_country_id, ['id' => 'country_id', 'class' => 'form-control']) !!}
                                                ...
                                                <td><select name="is_active" id="is_active" class="form-control">
                                                    ...
                                                    <select name="is_top" id="is_top" class="form-control">
                                                        <option value="-1">Is Top?</option>
                                                        <option value="1">In Top</option>
                                                        <option value="0">Not Top</option>
                                                    </select>

                                                    <select name="is_hot" id="is_hot" class="form-control">
                                                        <option value="-1">Is Hot?</option>
                                                        <option value="1">In Hot</option>
...
@push('scripts')
    <script>
        $(function() {
            ...
            $('#is_top').on('change', function(e) {
                oTable.draw();
                e.preventDefault();
            });
            $('#is_hot').on('change', function(e) {
                oTable.draw();
                e.preventDefault();
            });
        ...
        function makeNotHot(id) {
            $.post("{{ route('make.not.hot.job') }}", {
                    id: id,
                    _method: 'PUT',
                    _token: '{{ csrf_token() }}'
                })
