                    ...
                    <div class="userbtns">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item"><a class="nav-link {{ $c_or_e == 'candidate' ? 'active' : '' }}"
                                    data-toggle="tab" href="#candidate" aria-expanded="true">{{ __('Job Seeker') }}</a>
                            </li>
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="formrow{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                    ...
                                    @if ($errors->has('first_name')) <span
                                            class="help-block"> <strong>{{ $errors->first('first_name') }}</strong>
                                        </span> @endif
                                </div>
                                ...
                                <div class="formrow{{ $errors->has('middle_name') ? ' has-error' : '' }}">
                                    ...
                                    @if ($errors->has('middle_name')) <span
                                            class="help-block"> <strong>{{ $errors->first('middle_name') }}</strong>
                                        </span> @endif
                                </div>
                                ...
                                <div class="formrow{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                    ...
                                    @if ($errors->has('last_name')) <span
                                            class="help-block"> <strong>{{ $errors->first('last_name') }}</strong>
                                        </span> @endif
                                </div>
                                ...
                                <div class="formrow{{ $errors->has('is_subscribed') ? ' has-error' : '' }}">
                                    ...
                                    <input type="checkbox" value="1" name="is_subscribed"
                                        {{ $is_checked }} />{{ __('Subscribe to news letter') }}

                                    @if ($errors->has('is_subscribed')) <span
                                            class="help-block"> <strong>{{ $errors->first('is_subscribed') }}</strong>
                                        </span> @endif
                                </div>
                                ...
                                <div class="formrow{{ $errors->has('terms_of_use') ? ' has-error' : '' }}">
                                    ...
                                    @if ($errors->has('terms_of_use')) <span
                                            class="help-block"> <strong>{{ $errors->first('terms_of_use') }}</strong>
                                        </span> @endif
                                </div>
