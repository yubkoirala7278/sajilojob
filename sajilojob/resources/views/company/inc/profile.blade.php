{!! Form::model($company, ['method' => 'put', 'route' => ['update.company.profile'], 'class' => 'form', 'files' => true]) !!}
<h5>{{ __('Acount Information') }}</h5>
<div class="row">
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'email') !!}">
            <label>{{ __('Email') }}</label>
            {!! Form::text('email', null, ['class' => 'form-control', 'id' => 'email', 'placeholder' => __('Company Email')]) !!}
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow">
            ...
            <label style="background:#373092" class="btn btn-default"> {{ __('Select Company Logo') }}
...
<div class="row">
    <div class="col-md-6">
        <div class="formrow">
            <label>{{ __('Company Background Image') }}</label>
            {{ ImgUploader::print_image("company_bg_images/$company->bg_image", 700, 200) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="formrow">
            <div id="thumbnail-bg-image"></div>
            <label style="background:#373092" class="btn btn-default"> {{ __('Select Company Background Image') }}
                <input type="file" name="bg_image" id="bg-image" style="display: none;">
            </label>
            {!! APFrmErrHelp::showErrors($errors, 'bg_image') !!}
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'name') !!}">
            ...
            {!! Form::text('name', null, ['class' => 'form-control', 'id' => 'name', 'placeholder' => __('Company Name')]) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'ceo') !!}">
            ...
            {!! Form::text('ceo', null, ['class' => 'form-control', 'id' => 'ceo', 'placeholder' => __('Company CEO')]) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'industry_id') !!}">
            ...
            {!! Form::select('industry_id', ['' => __('Select Industry')] + $industries, null, ['class' => 'form-control', 'id' => 'industry_id']) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'ownership_type') !!}">
            ...
            {!! Form::select('ownership_type_id', ['' => __('Select Ownership type')] + $ownershipTypes, null, ['class' => 'form-control', 'id' => 'ownership_type_id']) !!}
    ...
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'description') !!}">
            ...
            {!! Form::textarea('description', null, ['class' => 'form-control', 'id' => 'description', 'placeholder' => __('Company details')]) !!}
    ...
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'location') !!}">
            ...
            {!! Form::text('location', null, ['class' => 'form-control', 'id' => 'location', 'placeholder' => __('Location')]) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'no_of_offices') !!}">
            ...
            {!! Form::select('no_of_offices', ['' => __('Select num. of offices')] + MiscHelper::getNumOffices(), null, ['class' => 'form-control', 'id' => 'no_of_offices']) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'no_of_employees') !!}">
            ...
            {!! Form::select('no_of_employees', ['' => __('Select num. of employees')] + MiscHelper::getNumEmployees(), null, ['class' => 'form-control', 'id' => 'no_of_employees']) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'established_in') !!}">
            ...
            {!! Form::select('established_in', ['' => __('Select Established In')] + MiscHelper::getEstablishedIn(), null, ['class' => 'form-control', 'id' => 'established_in']) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'website') !!}">
            ...
            {!! Form::text('website', null, ['class' => 'form-control', 'id' => 'website', 'placeholder' => __('Website')]) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'fax') !!}">
            <label>{{ __('Fax') }}</label>
            {!! Form::text('fax', null, ['class' => 'form-control', 'id' => 'fax', 'placeholder' => __('Fax')]) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'linkedin') !!}">
            ...
            {!! Form::text('linkedin', null, ['class' => 'form-control', 'id' => 'linkedin', 'placeholder' => __('Linkedin')]) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'google_plus') !!}">
            ...
            {!! Form::text('google_plus', null, ['class' => 'form-control', 'id' => 'google_plus', 'placeholder' => __('Google+')]) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'pinterest') !!}">
            ...
            {!! Form::text('pinterest', null, ['class' => 'form-control', 'id' => 'pinterest', 'placeholder' => __('Pinterest')]) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'country_id') !!}">
            ...
            {!! Form::select('country_id', ['' => __('Select Country')] + $countries, old('country_id', isset($company) ? $company->country_id : $siteSetting->default_country_id), ['class' => 'form-control', 'id' => 'country_id']) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'state_id') !!}">
            ...
            <span id="default_state_dd"> {!! Form::select('state_id', ['' => __('Select State')], null, ['class' => 'form-control', 'id' => 'state_id']) !!} </span> {!! APFrmErrHelp::showErrors($errors, 'state_id') !!}
        </div>
    </div>
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'city_id') !!}">
            <label>{{ __('City') }}</label>
            <span id="default_city_dd"> {!! Form::select('city_id', ['' => __('Select City')], null, ['class' => 'form-control', 'id' => 'city_id']) !!} </span> {!! APFrmErrHelp::showErrors($errors, 'city_id') !!}
        </div>
    </div>
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'map') !!}">
            <label>{{ __('Google Map Iframe') }}</label>
            {!! Form::textarea('map', null, ['class' => 'form-control', 'id' => 'map', 'placeholder' => __('Google Map')]) !!}
    ...
    <div class="col-md-12">
        <div class="formrow">
            <button type="submit" style="background:#373092" class="btn">{{ __('Update Profile and Save') }} <i
...
@push('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var fileInput = document.getElementById("bg-image");
            fileInput.addEventListener("change", function(e) {
                var files = this.files
                showThumbnailBg(files)
            }, false)
        });
        ...
        function showThumbnail(files) {
            ...
            for (var i = 0; i < files.length; i++) {
                ...
                reader.onload = (function(theFile) {
                    return function(e) {
                        $('#thumbnail').append('<div class="fileattached"><img height="100px" src="' + e.target
        ...
        function showThumbnailBg(files) {
            $('#thumbnail-bg-image').html('');
            for (var i = 0; i < files.length; i++) {
                var file = files[i]
                var imageType = /image.*/
                if (!file.type.match(imageType)) {
                ...
                reader.onload = (function(theFile) {
                    return function(e) {
                        $('#thumbnail-bg-image').append('<div class="fileattached"><img height="100px" src="' +
                            e.target.result + '" > <div>' + theFile.name +
                            '</div><div class="clearfix"></div></div>');
                    };
                }(file))
                var ret = reader.readAsDataURL(file);
