                            ...
                            <tr>
                                <td class="subtitle" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;font-weight:400;color:#333;padding-bottom:30px; text-align: left;">
                                    ...
                                    <p>
                                        <br>
                                        Front link :
                                        <span style="color: #fff;text-decoration: none; padding: 7px 10px;text-align: center;display: inline-block;margin-top: 20px;"><a href="{{ $link }}">{{ $link }}</a></span>
                                        <br>

                                        <br>
                                        Admin link : 
                                        <span style="color: #fff;text-decoration: none; padding: 7px 10px;text-align: center;display: inline-block;margin-top: 20px;"><a href="{{ $link_admin }}">{{ $link_admin }}</a></span>
                                        <br>
                                    </p>
                                </td>
                            </tr>
