        ...
        <tr>
            <td class="content-wrapper" style="padding-left:24px;padding-right:24px"><br>
                <div class="title" style="font-family: Helvetica, Arial, sans-serif; font-size: 18px;font-weight:400;color: #000;text-align: left;
                                 padding-top: 20px;">{{ $company_name }} ,</div>
            </td>
        </tr>
        <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                                <tr>
                                    <td class="subtitle"
                                        ...
                                        <p>"{{ $user_name }}" has applied on a job, posted by you "{{ $job_title }}"
                                        </p>
                                        <p>
                                            <br>
                                            Job seeker CV link :
                                            <span
                                                style="color: #fff;text-decoration: none; padding: 7px 10px;text-align: center;display: inline-block;margin-top: 20px;"><a
                                                    href="https://www.sajilojob.com/cvs/{{ $cv_link }}">CV
                                                    Link</a></span>
                                            <br>
                                            Job seeker profile link :
                                            <span
                                                style="color: #fff;text-decoration: none; padding: 7px 10px;text-align: center;display: inline-block;margin-top: 20px;"><a
                                                    href="{{ $user_link }}">{{ $user_link }}</a></span>
                                            <br>
