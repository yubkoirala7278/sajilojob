                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10">
                                    ...
                                    <ul class="row userdata">
                                        <li class="col-lg-6 col-md-6"><i class="fa fa-phone" aria-hidden="true"></i>
                                            {{ auth()->user()->phone }}</li>
                                        <li class="col-lg-6 col-md-6"><i class="fa fa-envelope" aria-hidden="true"></i>
                                            {{ auth()->user()->email }}</li>
                                    </ul>
                            ...
                            <div class="profbox followbox">
                                ...
                                <ul class="followinglist">
                                    @if (isset($followers) && null !== $followers)
                                        @foreach ($followers as $follow) @php
