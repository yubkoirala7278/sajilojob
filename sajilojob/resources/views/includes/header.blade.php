        ...
        <div class="container-fluid1">
            <div class="row">
                <div class="col-lg-2 col-md-12 col-12"> <a href="{{ url('/') }}" class="logo"><img
                            src="{{ asset('/') }}images/sajilojoblogo37px.png"
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                @else
                                    <li class="nav-item"><a href="{{ url('/jobs') }}"
                                            class="nav-link">{{ __('Available Jobs') }}</a> </li>
                                @endif
                                <li class="nav-item {{ Request::url() == route('blogs') ? 'active' : '' }}"><a
                                        href="{{ route('blogs') }}" class="nav-link">{{ __('Job Blog') }}</a>
                                </li>
                                {{-- <li class="nav-item {{ Request::url() == route('contact.us') ? 'active' : '' }}"><a
                                    href="{{ route('contact.us') }}" class="nav-link">{{ __('Contact us') }}</a>
                            </li> --}}
                                @if (Auth::check())
                                    <li class="nav-item dropdown userbtn"><a
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="nav-item"><a href="{{ route('home') }}" class="nav-link"><i
                                                    ...
                                                    {{ __('Dashboard') }}</a> </li>
                                            <li class="nav-item"><a href="{{ route('my.profile') }}"
                                    ...
                                    @endif @if (Auth::guard('company')->check())
                                        <li class="nav-item postjob"><a style="background:#373092" href="{{ route('post.job') }}"
                                        ...
                                        <li class="nav-item dropdown userbtn"><a
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="nav-item"><a href="{{ route('company.home') }}"
                                                        class="nav-link"><i class="fa fa-tachometer"
                                                            aria-hidden="true"></i>
                                                        {{ __('Dashboard') }}</a> </li>
                                                <li class="nav-item"><a href="{{ route('company.profile') }}"
                                                        class="nav-link"><i class="fa fa-user" aria-hidden="true"></i>
                                                        {{ __('Company Profile') }}</a></li>
                                                <li class="nav-item"><a href="{{ route('post.job') }}"
                                                        class="nav-link"><i class="fa fa-desktop"
                                                            aria-hidden="true"></i>
                                                        {{ __('Post Job') }}</a></li>
                                                <li class="nav-item"><a href="{{ route('company.messages') }}"
                                                        class="nav-link"><i class="fa fa-envelope-o"
                                                            aria-hidden="true"></i>
                                        ...
                                        @endif @if (!Auth::user() && !Auth::guard('company')->user())
                                            ...
                                            <li class="nav-item"><a style="background:#373092" href="{{ route('register') }}"
