            ...
            <div class="srchbox seekersrch">
                <div class="input-group">
                    <input type="text" name="search" id="empsearch" value="{{ Request::get('search', '') }}"
                        ...
                        autocomplete="off" />
                    <span class="input-group-btn" style="background:#373092">
                        <input type="submit" style="background:#373092" class="btn" value="{{ __('Search Job Seeker') }}">
                    </span>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-8">
                        ...
                        <input type="text" name="search" id="jbsearch" value="{{ Request::get('search', '') }}"
                            class="form-control" placeholder="{{ __('Enter Skills or job title') }}"
                            autocomplete="off" />
                    </div>
                    <div class="col-lg-3 col-md-4">
                        <label for="">&nbsp;</label>
                        <input style="background:#373092" type="submit" class="btn" value="{{ __('Search Job') }}">
                    </div>
                </div>
                ...
                {{-- <div class="srcsubfld additional_fields">
                    <div class="row">
                        <div class="col-lg-{{ ((bool) $siteSetting->country_specific_site) ? 6 : 3 }}">
                            ...
                            {!! Form::select('functional_area_id[]', ['' => __('Select Functional Area')] + $functionalAreas, Request::get('functional_area_id', null), ['class' => 'form-control', 'id' => 'functional_area_id']) !!}
                        </div>
                        ...
                        <div class="col-lg-3">
                            <lab for="">{{ __('Select City') }}</lab <span id="city_dd">
