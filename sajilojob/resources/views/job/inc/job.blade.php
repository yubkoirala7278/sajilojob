...
@if (isset($job))
    {!! Form::model($job, ['method' => 'put', 'route' => ['update.front.job', $job->id], 'class' => 'form']) !!}
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'specification') !!}">
            {!! Form::label('specification', 'Job specification', ['class' => 'bold']) !!}
            {!! Form::textarea('specification', null, ['class' => 'form-control', 'id' => 'specification', 'placeholder' => __('Job specification')]) !!}
            {!! APFrmErrHelp::showErrors($errors, 'specification') !!} </div>
    </div>

    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'benefits') !!}">
            {!! Form::label('benefits', 'Job benefits', ['class' => 'bold']) !!}
            {!! Form::textarea('benefits', null, ['class' => 'form-control', 'id' => 'benefits', 'placeholder' => __('Job Benefits')]) !!}
    ...
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'skills') !!}">
            ...
            ?>
            {!! Form::select('skills[]', $jobSkills, $skills, ['class' => 'form-control select2-multiple', 'id' => 'skills', 'multiple' => 'multiple']) !!}
            {!! APFrmErrHelp::showErrors($errors, 'skills') !!} </div>
    </div>
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'country_id') !!}" id="country_id_div"> {!! Form::select('country_id', ['' => __('Select Country')] + $countries, old('country_id', isset($job) ? $job->country_id : $siteSetting->default_country_id), ['class' => 'form-control', 'id' => 'country_id']) !!}
    ...
    {{-- <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'salary_from') !!}" id="salary_from_div"> {!! Form::number('salary_from', null, ['class' => 'form-control', 'id' => 'salary_from', 'placeholder' => __('Salary from')]) !!}
            {!! APFrmErrHelp::showErrors($errors, 'salary_from') !!} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'salary_to') !!}" id="salary_to_div">
            {!! Form::number('salary_to', null, ['class' => 'form-control', 'id' => 'salary_to', 'placeholder' => __('Salary to')]) !!}
            {!! APFrmErrHelp::showErrors($errors, 'salary_to') !!} </div>
    </div> --}}
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'salary') !!}" id="salary_to_div">
            {!! Form::text('salary', null, ['class' => 'form-control', 'id' => 'salary', 'placeholder' => __('Salary')]) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'salary_period_id') !!}" id="salary_period_id_div"> {!! Form::select('salary_period_id', ['' => __('Select Salary Period')] + $salaryPeriods, null, ['class' => 'form-control', 'id' => 'salary_period_id']) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'career_level_id') !!}" id="career_level_id_div"> {!! Form::select('career_level_id', ['' => __('Select Career level')] + $careerLevels, null, ['class' => 'form-control', 'id' => 'career_level_id']) !!}
            {!! APFrmErrHelp::showErrors($errors, 'career_level_id') !!} </div>
    </div>

    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}" id="functional_area_id_div"> {!! Form::select('functional_area_id', ['' => __('Select Functional Area')] + $functionalAreas, null, ['class' => 'form-control', 'id' => 'functional_area_id']) !!}
            {!! APFrmErrHelp::showErrors($errors, 'functional_area_id') !!} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'job_type_id') !!}" id="job_type_id_div"> {!! Form::select('job_type_id', ['' => __('Select Job Type')] + $jobTypes, null, ['class' => 'form-control', 'id' => 'job_type_id']) !!}
            {!! APFrmErrHelp::showErrors($errors, 'job_type_id') !!} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'job_shift_id') !!}" id="job_shift_id_div"> {!! Form::select('job_shift_id', ['' => __('Select Job Shift')] + $jobShifts, null, ['class' => 'form-control', 'id' => 'job_shift_id']) !!}
            {!! APFrmErrHelp::showErrors($errors, 'job_shift_id') !!} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'num_of_positions') !!}" id="num_of_positions_div"> {!! Form::select('num_of_positions', ['' => __('Select number of Positions')] + MiscHelper::getNumPositions(), null, ['class' => 'form-control', 'id' => 'num_of_positions']) !!}
            {!! APFrmErrHelp::showErrors($errors, 'num_of_positions') !!} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}" id="gender_id_div"> {!! Form::select('gender_id', ['' => __('No preference')] + $genders, null, ['class' => 'form-control', 'id' => 'gender_id']) !!}
            {!! APFrmErrHelp::showErrors($errors, 'gender_id') !!} </div>
    </div>
    {{-- <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'expiry_date') !!}"> {!! Form::text('expiry_date', null, ['class' => 'form-control datepicker', 'id' => 'expiry_date', 'placeholder' => __('Job expiry date'), 'autocomplete' => 'off']) !!}
            {!! APFrmErrHelp::showErrors($errors, 'expiry_date') !!} </div>
    </div> --}}
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div"> {!! Form::select('degree_level_id', ['' => __('Select Required Degree Level')] + $degreeLevels, null, ['class' => 'form-control', 'id' => 'degree_level_id']) !!}
            {!! APFrmErrHelp::showErrors($errors, 'degree_level_id') !!} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}" id="job_experience_id_div"> {!! Form::select('job_experience_id', ['' => __('Select Required job experience')] + $jobExperiences, null, ['class' => 'form-control', 'id' => 'job_experience_id']) !!}
    ...
    <div class="col-md-12">
        <div class="formrow">
            <button type="submit" class="btn">{{ __('Update Job') }} <i class="fa fa-arrow-circle-right"
