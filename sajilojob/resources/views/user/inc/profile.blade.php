...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'middle_name') !!}">
            ...
            {!! Form::text('middle_name', null, ['class' => 'form-control', 'id' => 'middle_name', 'placeholder' => __('Middle Name')]) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'last_name') !!}">
            ...
            {!! Form::text('last_name', null, ['class' => 'form-control', 'id' => 'last_name', 'placeholder' => __('Last Name')]) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'father_name') !!}">
            ...
            {!! Form::text('father_name', null, ['class' => 'form-control', 'id' => 'father_name', 'placeholder' => __('Father Name')]) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}">
            ...
            {!! Form::select('gender_id', ['' => __('Select Gender')] + $genders, null, ['class' => 'form-control', 'id' => 'gender_id']) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'marital_status_id') !!}">
            ...
            {!! Form::select('marital_status_id', ['' => __('Select Marital Status')] + $maritalStatuses, null, ['class' => 'form-control', 'id' => 'marital_status_id']) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'country_id') !!}">
            ...
            <?php $country_id = old('country_id', isset($user) && (int) $user->country_id > 0 ?
            $user->country_id : $siteSetting->default_country_id); ?>
            {!! Form::select('country_id', ['' => __('Select Country')] + $countries, $country_id, ['class' => 'form-control', 'id' => 'country_id']) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'nationality_id') !!}">
            ...
            {!! Form::select('nationality_id', ['' => __('Select Nationality')] + $nationalities, null, ['class' => 'form-control', 'id' => 'nationality_id']) !!}
    ...
    <div class="col-md-6">
        ...
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'date_of_birth') !!}">
            ...
            {!! Form::date('date_of_birth', $dob, ['class' => 'form-control', 'id' => 'date_of_birth', 'placeholder' => __('Date of Birth'), 'autocomplete' => 'off']) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'national_id_card_number') !!}">
            ...
            {!! Form::text('national_id_card_number', null, ['class' => 'form-control', 'id' => 'national_id_card_number', 'placeholder' => __('National ID Card#')]) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'mobile_num') !!}">
            ...
            {!! Form::text('mobile_num', null, ['class' => 'form-control', 'id' => 'mobile_num', 'placeholder' => __('Mobile Number')]) !!}
    ...
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'street_address') !!}">
            ...
            {!! Form::textarea('street_address', null, ['class' => 'form-control', 'id' => 'street_address', 'placeholder' => __('Street Address')]) !!}
...
<div class="row">
    <div class="col-md-12" id="video_link_id">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'video_link') !!}">
            ...
            {!! Form::textarea('video_link', null, ['class' => 'form-control', 'id' => 'video_link', 'placeholder' => __('Video Link')]) !!}
...
<div class="row">
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}">
            ...
            {!! Form::select('job_experience_id', ['' => __('Select Experience')] + $jobExperiences, null, ['class' => 'form-control', 'id' => 'job_experience_id']) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'career_level_id') !!}">
            ...
            {!! Form::select('career_level_id', ['' => __('Select Career Level')] + $careerLevels, null, ['class' => 'form-control', 'id' => 'career_level_id']) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}">
            ...
            {!! Form::select('functional_area_id', ['' => __('Select Functional Area')] + $functionalAreas, null, ['class' => 'form-control', 'id' => 'functional_area_id']) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'current_salary') !!}">
            ...
            {!! Form::text('current_salary', null, ['class' => 'form-control', 'id' => 'current_salary', 'placeholder' => __('Current Salary')]) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'expected_salary') !!}">
            ...
            {!! Form::text('expected_salary', null, ['class' => 'form-control', 'id' => 'expected_salary', 'placeholder' => __('Expected Salary')]) !!}
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}">
            ...
            @endphp
            {!! Form::text('salary_currency', $salary_currency, ['class' => 'form-control', 'id' => 'salary_currency', 'placeholder' => __('Salary Currency'), 'autocomplete' => 'off']) !!}
