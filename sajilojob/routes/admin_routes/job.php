...
Route::put('make-top-job', array_merge(['uses' => 'Admin\JobController@makeTopJob'], $all_users))->name('make.top.job');
Route::put('make-not-top-job', array_merge(['uses' => 'Admin\JobController@makeNotTopJob'], $all_users))->name('make.not.top.job');
Route::put('make-hot-job', array_merge(['uses' => 'Admin\JobController@makeHotJob'], $all_users))->name('make.hot.job');
Route::put('make-not-hot-job', array_merge(['uses' => 'Admin\JobController@makeNotHotJob'], $all_users))->name('make.not.hot.job');
